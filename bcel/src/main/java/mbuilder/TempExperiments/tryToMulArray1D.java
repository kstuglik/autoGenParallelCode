...
public class tryToMulArray1D {
    ...
    public static int create_field_ldc_integer(String name, Integer value) {
        lg = tryToMulArray1D.mg.addLocalVariable(name, Type.INT, null, null);
        int id = lg.getIndex();
...
//        mg.stripAttributes(true);
    ...
    public static void println_string(String result) {
        il.append(factory.createPrintln(result));
    }
    ...
    public static void main(String[] args) {
        ...
        //        }
        /////////////////////////////////////////////////////////////
        tryToMulArray1D fL = new tryToMulArray1D();
...
//        println_integer(id_C,id_c);
        ...
        confirm_and_save("src/main/java/mbuilder/classFiles/MatrixMultiply.class");
    }
}