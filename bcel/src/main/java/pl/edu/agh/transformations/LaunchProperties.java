...
public class LaunchProperties {
    ...
    //    WARNING: task polll is generic list, its the first var_index in method
    public static final int TASK_POOL_ID = 0;
    ...
    public static final String FINAL_END_INDEX_VARIABLE_NAME = "finalEnd";
