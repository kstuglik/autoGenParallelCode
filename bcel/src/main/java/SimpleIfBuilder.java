...
public class SimpleIfBuilder {
    ...
    public static void main(String[] args) {
        ...
        BranchHandle ifh=il.append(new IF_ICMPGE(null)); // We do not yet know the position of the target. Will set it later.
        //Push the String to print
        il.append(new LDC(cp.addString("Less than five")));
        ...
        BranchHandle gotoHandle=il.append(new GOTO(null));// We do not yet know the position of the target. Will set it later.
        ...
        try {
            cg.getJavaClass().dump("src/main/generated/SimpleIf.class");
        } catch (IOException e) {
